# File: convert_forms.py
# Purpose: Batch conversion of VBA .frm files to tkinter GUI scripts
# Author: Rolf-Günther
# Created: 2025-10-12
# Updated: 2025-10-12
# Source Directory: VBA_Sources/
...
def generate_tkinter_gui(parsed: dict, source_path: Path) -> str:
    ...
    metadata = [
        ...
        f'# Author: Rolf-Günther via convert_forms.py',
        ''
    ]
