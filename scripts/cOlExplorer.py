...
print(Debug.Print "cOlExplorer class Inited with Events for ActiveExplorer and Explorers")
...
print(Debug.Print "cOlExplorer RegisterClose called")
...
print(Debug.Print "cOlExplorer OlExplorers_Close called")
...
def register_event_handler():
    print(Debug.Print "cOlExplorer Register_Event_Handler called")
...
print(Debug.Print "cOlExplorer NewExplorer called for new Explorer Window: " & Explorer.Caption)
