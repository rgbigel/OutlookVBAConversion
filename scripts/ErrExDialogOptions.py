# Converted from ErrExDialogOptions.py

# VERSION 1.0 CLASS
# BEGIN
# MultiUse = -1  'True
# END
# Attribute VB_Name = "ErrExDialogOptions"
...
def loadcustomimagefromfile():
    # Call VCOMObject.LoadCustomImageFromFile(FilePath)

def internalcompressdata():
