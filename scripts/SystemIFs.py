...
# WS_CHILD = &H40000000                        'Kindfenster. Kann kein Men haben und nicht Popup
# WS_CLIPCHILDREN = &H2000000                  'Verhindert Kindfenster auerhalb des Elternfensters
# WS_CLIPSIBLINGS = &H4000000                  'Verhindert sich gegenseitig berlappende Kindfenster
...
# WS_OVERLAPPED = &H0                          'berlappendes Fenster. Hat Titelleiste und Rahmen
# WS_popup = &H80000000                        'Popupfenster
# WS_SIZEBOX = &H40000                         'Fenster hat grenvernderbaren Rahmen
# WS_SYSMENU = &H80000                         'Fenster hat Windowsmen in der Titelleiste
# WS_VISIBLE = &H10000000                      'Fenster ist initial sichtbar
# WS_VSCROLL = &H200000                        'Fenster hat vertikale Scrollleiste
# End Enum

# 'EXTENDED_WINDOWS_STYLES ist stark unvollstndig, da in VBA kaum Bedarf dafr besteht
...
# WS_EZ_TOPMOST = &H8                          'Fenster liegt selbst deaktiviert ber allen anderen
# End Enum

# Public Enum eCmd
# GW_FINDFIRST = 0                             'Erstes Fenster gleicher Ebene
# GW_FINDLAST = 1                              'Letztes Fenster gleicher Ebene
# GW_HWNDNEXT = 2                              'Nchstes Fenster gleicher Ebene
